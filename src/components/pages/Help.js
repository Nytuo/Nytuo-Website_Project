  ...
  return (
    <div>
      ...
      <ul class="collapsible">
          ...
          <div class="collapsible-body">
            <span>
              <p>
                ...
                Launcher.Vous pouvez vérifier les fichiers avec Virus Total qui
                permet l’analyse sur plusieurs base de données.Si vous souhaiter
          ...
          <div class="collapsible-body">
            <span>
              ...
              <p>
                ...
                choisissez,"nytuolauncher-[dernière version].zip" et allez voir
                la section "Portable Edition"{" "}
              </p>
              <p>
                II/Clique droit sur le ".appimage" puis "propriétés".Cocher dans
                "permissions" la case "Executer comme une application".Double
                cliques sur le fichier ".appimage" pour l'executer.
              </p>
              <p>
                Lors du premier lancement du launcher vous serez inviter à
                selectionner un dossier où stocker les jeux (ce dossier doit
          ...
          <div class="collapsible-body">
            <span>
              <p>
                ...
                <br />
                I/Dans les paramètres se trouve l'emplacement du dossier "Games"
                contenant les jeux.Suivez cette emplacement dans l'explorateur
                de fichier.
                <br />
        ...
        <li>
          <div class="collapsible-header">Mettre à jour le Nytuo Launcher</div>
          <div class="collapsible-body">
            <span>
              <p>
                Sur Windows: Si une mise à jour est disponible, le Nytuo
                Launcher la télécharge au démarrage, se ferme et lance un Batch
                (fichier en .bat lançant un invite de commandes (CMD)) de
                manière à lancer le programme de mise à jour de manière différé
                et que le launcher puisse se fermer correctement.
                <br />
                ...
                <br />
                Note : Vous pouvez forcer la mise à jour du launcher depuis les
                paramètres
                <br />
                Note II : en mode portable, les mises à jour sont désactiver, le
                guide pour mettre à jour le launcher en mode portable se trouve
                dans la section "portable".
              </p>
            </span>
          </div>
        </li>
        ...
        <li>
          ...
          <div class="collapsible-body">
            <span>
              <p>
                Le Nytuo Launcher existe en version portable. Elle ne nécessite
                donc pas d'installation.Cependant, les mises à jour automatiques
                sont désactivés et le dossier des jeux ne peut être choisi.
              </p>
              <p>
              ...
              <p>
                ...
                nom n'a pas d'importance) puis extrayer le contenu de l'archive
                dans ce dossier.
              </p>
              <p>
                ...
                causeront problèmes et le dossier des jeux ne sera pas portable.
              </p>
              <p>
        ...
        <li>
          ...
          <div class="collapsible-body">
            <span>
              <p>
                Visiter la section "FeedBack" du site ou rendez-vous sur GitHub
                et créé une nouvelle "issue"
              </p>
          ...
          <div class="collapsible-body">
            <span>
              <p>
                ...
                fonctionne pas ! Vous devez fermer le jeu pour retrouver l'accès
                au launcher.
              </p>
              <p>
                II/ Sous Linux, Pour lancer le launcher dans le cas où, celui-ci
                ne ce lance pas, veuillez à cocher la case dans l'onglet
                "permissions" des "propriétés" du fichier et réessayer.Si
                l'erreur persiste, envoyer un feedback.
              </p>
            </span>
          </div>
        </li>
          ...
          <div class="collapsible-body">
            <span>
              <p>
                ...
                nécessaire pour accéder aux pages des jeux sur ce dernier. Cela
                me permet de gérer d'éventuelles jeux payant, de m'entrainer à
                gérer des bases de données et à apprendre le language 'PHP', et
                me permet d'inclure dans mes jeux un nom d'utilisateur
                customisé. Pour créé un compte, ce qui est gratuit, aller sur la
                page profile du site ou ouvrer le Nytuo Launcher. Cliquer sur
                'créé un compte' à coté de 'se connecter' et renseigner les
                champs requis. Noter que le mot de passe doit-etre facile a
                retenir en cas de reconnexion mais doit aussi etre unique a ce
                site en cas de hack de la base de donnée; il doit également être
                assez complexe pour ne pas etre deviner. Pour vous connecter,
                cela ce fait sur la page profile du site. Si vous perdez votre
                mot de passe, un systeme de mail a était mis au point, vous
                receverez un mail avec un lien de réinitialisation de mot de
                passe votre compte.
                <br />
                ...
                profile, vous pouvez voir les jeux posséder sur votre compte et
                pouvez en activer un à l'aide d'une clé qui vous sera envoyé par
                mail si besoin (dans le cadre de jeux payant, les jeux gratuits
                seront automatiquement activés). Votre compte peut-être
                également utilisé dans le Nytuo Launcher pour que vous puissiez
                retrouver votre Nom d'Utilisateur dans les jeux et accéder à vos
                jeux.Toutes les fonctionnalités du site lié aux comptes sont
                partagés avec le launcher et sont également disponible sur ce
                dernier. Si vous cochez l'option 'se souvenir de moi', le mot de
                passe est stocké dans un cookie ( chiffré ), ainsi que votre nom
                d'utilisateur, pour vous permettre une reconnexion plus simple.
                Sur le Launcher, votre mot de passe est stocké dans un fichier
                txt sur votre machine, il n'est cependant pas sécurisé.
              </p>
            </span>
          </div>
        </li>
