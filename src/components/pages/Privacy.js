...
function Privacy() {
  return (
    <div>
      ...
      <p>
        At Nytuo, accessible from https://nytuowebsite.web.app, one of our main
        priorities is the privacy of our visitors. This Privacy Policy document
        contains types of information that is collected and recorded by Nytuo
        and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in Nytuo. This policy is not applicable to any
      ...
      <p>
        Nytuo follows a standard procedure of using log files. These files log
      ...
      <p>
        Like any other website, Nytuo uses 'cookies'. These cookies are used to
      ...
      <p>
        ...
        advertising partners of Nytuo.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on Nytuo, which are sent directly
      ...
      <p>
        Note that Nytuo has no access to or control over these cookies that are
      ...
      <p>
        Nytuo's Privacy Policy does not apply to other advertisers or websites.
      ...
      <p>
        Nytuo does not knowingly collect any Personal Identifiable Information
