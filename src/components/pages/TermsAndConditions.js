  ...
  return (
    <div>
      ...
      <p>
        ...
        conditions in full. Do not continue to use Nytuo's website if you do not
      ...
      <h2>Cookies</h2>
      <p>
        We employ the use of cookies. By using Nytuo's website you consent to
        the use of cookies in accordance with Nytuo's privacy policy.
      </p>
      <p>
      ...
      <p>
        ...
        Nytuo; and (d) where the link is in the context of general resource
      ...
      <p>
        ...
        e-mail to{" "}
        <a
          href="mailto:nytuo.yt@gmail.com"
          title="send an email to nytuo.yt@gmail.com"
        >
          nytuo.yt@gmail.com
        </a>
      ...
      <p>
        No use of Nytuo's logo or other artwork will be allowed for linking
      ...
      <h2>Accounts</h2>
      <p>
        On our website they are an accounts system. By continue using our
        website, you accept us can access to your login mail,
        password(encrypted) and Username and we can edit or delete account or
        account informations. Our website use cookies and can stock on them your
        creditentials for the website (like password or username) for futur
        connexion, for reduce the time of login.
      </p>
