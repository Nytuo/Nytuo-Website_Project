...
function NytuoLauncher() {
 ...
 <div style={{textAlign: "center",paddingTop: "100px"}}>
    ...
    <div style={{textAlign:"center"}}>
        <ButtonA link="nytuo://"><i
                class="material-icons right">launch</i>Ouvrir le Nytuo Launcher</ButtonA>
                <ButtonA link="https://launcher.nytuo.yo.fr/profile.php"><i class="material-icons right">launch</i>Ouvrir page
            Launcher</ButtonA>
    </div>

    <p>Le Nytuo Launcher est un lanceur pour les jeux de Nytuo. Il est fait maison. Il permet de télécharger, mettre à jour, lancer et supprimer les jeux de Nytuo.<br /> Le Nytuo Launcher apporte des fonctionnalités comme les succès (achievements, pour les
        jeux supportés), raccourcies sur le bureau (windows uniquement), réparation, et plus...<br />Le Nytuo Launcher est en dévelopement actif, cela veut dire qu'il subit beaucoup de modifications et de nouvelles fonctionnalités sont apportés à chaque
        mise à jour (pas vraiment à chaque mise à jour mais régulièrement).</p>
    <h1>Informations :</h1>
    <p>Plateformes : Windows(x64), linux(x64)<br />Languages : Français, Anglais et Espagnol<br />Necessite la connexion ou la création à un compte Nytuo (Gratuit)</p>
    ...
    <div style={{textAlign: "center"}}>
        <ButtonA link="https://github.com/Nytuo/Nytuo-Launcher/releases/latest"><i
                class="material-icons right">launch</i>Télécharger sur GITHUB</ButtonA>
                <ButtonA link="https://github.com/Nytuo/Nytuo-Launcher"><i class="material-icons right">launch</i>Voir le code sur
            GITHUB</ButtonA>
            <ButtonA link="help"><i
                class="material-icons right">help_outline</i>Voir l'aide
            (recommandée)</ButtonA>
        <div style={{paddingTop: "5px"}}></div>
    </div>
    <h1>Fonctionnalités:</h1>
    <p>-Téléchargements des jeux.<br />-Mise à jour des jeux<br />-Lancement des jeux<br />-Systeme de succès (pour les jeux pris en charges)<br />-Reparation, re-téléchargement et suppression des jeux<br />-Mise à jour du launcher automatique
        <br />-Jouer sans téléchargement en HTML5 (nécessite une connexion internet, seulement pour certains jeux compatibles)<br />-Sauvegarde locale (pour certains jeux ayant des sauvegardes et compatibles)
        <br />-Création de raccourcie sur le bureau Windows uniquement</p><br></br>
      <h1>Changes-Logs:</h1>
      <p>
