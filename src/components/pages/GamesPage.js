            ...
            <div className="card">
              ...
              <div className="card-body">
                ...
                <p className="card-text">
                  Survie a des vagues de Zombies en 2D</p>
          ...
          <div className="homeresize">
            <div className="card">
              ...
              <div className="card-body">
                ...
                <p className="card-text">Tu viens pour des vacances mais quelque chose va nuir a ton
                  séjour</p>
          ...
          <div className="homeresize">
            <div className="card">
              ...
              <div className="card-body">
                ...
                <p className="card-text">Un jeu a la Mario pour le mariage de mon cousin Geoffrey</p>
          ...
          <div className="homeresize">
            <div className="card">
              ...
              <div className="card-body">
                ...
                <p className="card-text">Survie a des vagues de Zombies en 3D</p>
                <a href="/shootFighter" className="btn btn-primary">Voir</a>
              </div>
            </div>
          </div>
          <div className="homeresize">
            <div className="card">
              ...
              <div className="card-body">
                ...
                <p className="card-text">Retrouve toutes les pièces et monte en haut de la tour</p>
                <a href="/lutinAdventure" className="btn btn-primary">Voir</a>
              </div>
            </div>
          </div>
          <div className="homeresize">
            <div className="card">
              ...
              <div className="card-body">
                ...
                <p className="card-text">Retrouve touts les composants pour quitter la foret</p>
                <a href="/vincentInTheForest" className="btn btn-primary">Voir</a>
              </div>
            </div>
          </div>
          <div className="homeresize">
            <div className="card">
              ...
              <div className="card-body">
                ...
                <p className="card-text">Protège le TARDIS des Cybermans et des Daleks</p>
                <a href="/theTardisDefender" className="btn btn-primary">Voir</a>
              </div>
            </div>
          </div>
          <div className="homeresize">
            <div className="card">
              ...
              <div className="card-body">
                ...
                <p className="card-text">Evite la destruction du processeur en plaçant des tourelles
                  pour detruire les virus</p>
                <a href="/fireWallDefender" className="btn btn-primary">Voir</a>
              </div>
            </div>
          </div>
          <div className="homeresize">
            <div className="card">
              ...
              <div className="card-body">
                ...
                <a href="/tanksBattle" className="btn btn-primary">Voir</a>
              </div>
            </div>
          </div>
          <div className="homeresize">
            <div className="card">
              ...
              <div className="card-body">
                ...
                <a href="/winrun" className="btn btn-primary">Voir</a>
              </div>
            </div>
          </div>
          <div className="homeresize">
            <div className="card">
              ...
              <div className="card-body">
                ...
                <p className="card-text">Détruit tout les astéroids et essaye de marquer le plus de
                  point</p>
                <a href="/asteroidEscape" className="btn btn-primary">Voir</a>
              </div>
            </div>
          </div>
          <div className="homeresize">
            <div className="card">
              ...
              <div className="card-body">
                ...
                <a href="/sansNomReedition" className="btn btn-primary">Voir</a>
              </div>
            </div>
          </div>
        </div>
